...
// FileSummary: Authors and previews one scalar-parameter regular polygon.
//////////////////////////////////////////////////////////////////////

/* [Regular polygon] */
side_count = 5; // integer, 3 or greater
dimension_kind = "side_length"; // [side_length,circumradius,apothem]
dimension_value_mm = 100; // positive millimetres
corner_radius_mm = 5; // positive millimetres
