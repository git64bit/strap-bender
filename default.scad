...
/* [Project selection] */
project_name_selected = "BEND_PROGRAM_LAB"; // [BEND_PROGRAM_LAB,VERTEX_POLYGON_LAB,REGULAR_POLYGON_LAB,WAVE_PATTERN_LAB,CATALOG_WORKBENCH_STUB]
...
regular_polygon_name_selected = "REGULAR_TRIANGLE_SIDE_100_R5"; // [REGULAR_TRIANGLE_SIDE_100_R5,REGULAR_SQUARE_APOTHEM_50_R10,REGULAR_PENTAGON_CIRCUMRADIUS_60_MIXED,REGULAR_NONAGON_EVERY_THIRD_R5]

/* [Pattern instance selection] */
pattern_instance_name_selected = "THIRTY_WAVE_EVERY_THIRD_R5"; // [THIRTY_WAVE_EVERY_THIRD_R5,SIX_WAVE_VARIABLE_SEGMENTS]
